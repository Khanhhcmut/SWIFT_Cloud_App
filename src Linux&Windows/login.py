...
from PyQt5.QtWidgets import (
    ...
    QMessageBox, QFrame, QSizePolicy, QApplication, QDialog,
    QTextEdit, QDialogButtonBox, QRadioButton, QInputDialog
)
from PyQt5.QtGui import QFont, QPixmap, QPalette, QBrush, QIcon
from PyQt5.QtCore import Qt

from main import MainWindow
from utils import resource_path, load_app_config
    ...
    def login(self):
        ...
        try:
            ...
            if resp.status_code == 201:
                ...
                self.main_window.total_quota_bytes = self.main_window.load_quota()
                self.main_window.update_usage_display()
